				...
				<div class="col-sm-12">
					...
					<div class="col-sm-4">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<div class="radio">
									<label><input type="radio" name="rb" id="rbGroup"
										value="Group" onclick="disableEmployee();" checked>Group</label>
								</div>
								<div class="radio">
									<label><input type="radio" name="rb" id="rbEmployee"
										value="Employee" onclick="disableGroup();">Employee</label>
								</div>
				...
				<div class="col-sm-12">
					...
					<div class="col-sm-8">
							...
							<div class="form-group">
								...
								<div class="col-sm-12">
									<input type="text" class="form-control" name="section1"
										...
										value="<%=report.getSectionName()%>" disabled> <span class="error"></span>
								</div>
							</div>
						...
						<div class="col-sm-4">
							...
							<%
							for(int j = 0; j < ReportService.getSectionCriteria(report.getSectionID()).size(); j++){
							%>
							<div class="form-group">
